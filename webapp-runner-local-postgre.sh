...
java $JAVA_OPTS -javaagent:../../server/newrelic/newrelic.jar -Dnewrelic.environment=development -Dgrails.env=production -jar ../../server/webapp-runner.jar --port 8000 *.war
